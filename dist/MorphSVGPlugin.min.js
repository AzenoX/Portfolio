...
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : (0, _typeof2["default"])(exports)) && "undefined" != typeof module ? e(exports) : "function" == typeof define && define.amd ? define(["exports"], e) : e((t = t || self).window = t.window || {});
}(void 0, function (t) {
  "use strict";
  ...
  function convertToPath(t, e) {
    ...
    return "path" !== T && t.getBBox ? (h = function _createPath(t, e) {
      ...
      for (e = "," + e + ","; -1 < --o;) {
        r = a[o].nodeName.toLowerCase(), e.indexOf("," + r + ",") < 0 && n.setAttributeNS(null, r, a[o].nodeValue);
      }
  ...
  function arcToSegment(t, e, r, n, a, o, i, h, s) {
    if (t !== h || e !== s) {
      ...
      for (V = 0; V < I; V++) {
        _ = E(a = C + V * X), P = D(a), A = E(a += X), R = D(a), L.push(_ - U * P, P + U * _, A + U * R, R - U * A, A, R);
      }
  ...
  function stringToRawPath(t) {
    ...
    for (e = 0; e < y; e++) {
      if (u = o, isNaN(_[e]) ? i = (o = _[e].toUpperCase()) !== _[e] : e--, n = +_[e + 1], a = +_[e + 2], i && (n += v, a += m), e || (s = n, l = a), "M" === o) h && (h.length < 8 ? --P.length : w += h.length), v = s = n, m = l = a, h = [n, a], P.push(h), e += 2, o = "L";else if ("C" === o) i || (v = m = 0), (h = h || [0, 0]).push(n, a, v + 1 * _[e + 3], m + 1 * _[e + 4], v += 1 * _[e + 5], m += 1 * _[e + 6]), e += 6;else if ("S" === o) g = v, c = m, "C" !== u && "S" !== u || (g += v - h[h.length - 4], c += m - h[h.length - 3]), i || (v = m = 0), h.push(g, c, n, a, v += 1 * _[e + 3], m += 1 * _[e + 4]), e += 4;else if ("Q" === o) g = v + 2 / 3 * (n - v), c = m + 2 / 3 * (a - m), i || (v = m = 0), v += 1 * _[e + 3], m += 1 * _[e + 4], h.push(g, c, v + 2 / 3 * (n - v), m + 2 / 3 * (a - m), v, m), e += 4;else if ("T" === o) g = v - h[h.length - 4], c = m - h[h.length - 3], h.push(v + g, m + c, n + 2 / 3 * (v + 1.5 * g - n), a + 2 / 3 * (m + 1.5 * c - a), v = n, m = a), e += 2;else if ("H" === o) uc(v, m, v = n, m), e += 1;else if ("V" === o) uc(v, m, v, m = n + (i ? m - v : 0)), e += 1;else if ("L" === o || "Z" === o) "Z" === o && (n = s, a = l, h.closed = !0), ("L" === o || .5 < k(v - n) || .5 < k(m - a)) && (uc(v, m, n, a), "L" === o && (e += 2)), v = n, m = a;else if ("A" === o) {
        if (f = _[e + 4], d = _[e + 5], g = _[e + 6], c = _[e + 7], r = 7, 1 < f.length && (f.length < 3 ? (c = g, g = d, r--) : (c = d, g = f.substr(2), r -= 2), d = f.charAt(1), f = f.charAt(0)), p = arcToSegment(v, m, +_[e + 1], +_[e + 2], +_[e + 3], +f, +d, (i ? v : 0) + 1 * g, (i ? m : 0) + 1 * c), e += r, p) for (r = 0; r < p.length; r++) {
          h.push(p[r]);
        }
  ...
  function rawPathToString(t) {
    ...
    for (r = 0; r < i; r++) {
      for (a = t[r], o += "M" + s(a[0]) + "," + s(a[1]) + " C", e = a.length, n = 2; n < e; n++) {
        o += s(a[n++]) + "," + s(a[n++]) + " " + s(a[n++]) + "," + s(a[n++]) + " " + s(a[n++]) + "," + s(a[n]) + " ";
      }
  ...
  function P(t) {
    ...
    for (n = 6; n < a; n += 6) {
      o < (e = t[n]) ? o = e : e < i && (i = e), h < (r = t[n + 1]) ? h = r : r < s && (s = r);
    }
  ...
  function Q(t, e) {
    ...
    for (var r, n, a, o, i, h, s, l, g, c, p, u, f, d, _, P, v = t.length, m = t[0][0], y = m, w = t[0][1], M = w, x = 1 / e; -1 < --v;) {
      for (r = (i = t[v]).length, o = 6; o < r; o += 6) {
        for (g = i[o], c = i[o + 1], p = i[o + 2] - g, d = i[o + 3] - c, u = i[o + 4] - g, _ = i[o + 5] - c, f = i[o + 6] - g, P = i[o + 7] - c, h = e; -1 < --h;) {
          m < (n = ((s = x * h) * s * f + 3 * (l = 1 - s) * (s * u + l * p)) * s + g) ? m = n : n < y && (y = n), w < (a = (s * s * P + 3 * l * (s * _ + l * d)) * s + c) ? w = a : a < M && (M = a);
        }
      }
    }
  ...
  function U(t, e, r, n, a) {
    ...
    for (r *= 6, i = 0; i < l; i += 6) {
      s = t[o = (i + r) % c] - (e[i] - n), h = t[1 + o] - (e[i + 1] - a), g += _(h * h + s * s);
    }
  ...
  function V(t, e, r) {
    ...
    if (r) for (reverseSegment(n = t.slice(0)), o = 6; o < i; o += 6) {
  ...
  function W(t, e, r) {
    for (var n, a, o, i, h, s, l = t.length, g = 1e20, c = 0, p = 0; -1 < --l;) {
      for (s = (n = t[l]).length, h = 0; h < s; h += 6) {
        a = n[h] - e, o = n[h + 1] - r, (i = _(a * a + o * o)) < g && (g = i, c = n[h], p = n[h + 1]);
      }
    }
  ...
  function X(t, e, r, n, a, o) {
    ...
    for (i = r; i < g && !((e[i].size || P(e[i])) < p); i++) {
      h = e[i].centerX - f, s = e[i].centerY - d, (l = _(h * h + s * s)) < u && (c = i, u = l);
    }
  ...
  function Y(t, e) {
    ...
    for (f = 2; f < P; f += 6) {
      for (_ += v; .999999 < _;) {
        r = t[f - 2], n = t[f - 1], a = t[f], o = t[f + 1], i = t[f + 2], h = t[f + 3], s = t[f + 4], l = t[f + 5], g = r + (a - r) * (d = 1 / ((Math.floor(_) || 1) + 1)), g += ((p = a + (i - a) * d) - g) * d, p += (i + (s - i) * d - p) * d, c = n + (o - n) * d, c += ((u = o + (h - o) * d) - c) * d, u += (h + (l - h) * d - u) * d, t.splice(f, 4, r + (a - r) * d, n + (o - n) * d, g, c, g + (p - g) * d, c + (u - c) * d, p, u, i + (s - i) * d, h + (l - h) * d), f += 6, P += 6, _--;
      }
    }
  ...
  function aa(t, e) {
    ...
    for (r = .5 * e / (.5 * (a = t.length) - 1), n = 0; n < a - 2; n += 2) {
      if (l += r, h = parseFloat(t[n + 2]), s = parseFloat(t[n + 3]), .999999 < l) for (i = 1 / (Math.floor(l) + 1), o = 1; .999999 < l;) {
        p += (g + (h - g) * i * o).toFixed(2) + "," + (c + (s - c) * i * o).toFixed(2) + " ", l--, o++;
      }
      p += h + "," + s + " ", g = h, c = s;
    }
  ...
  function ca(e) {
    return isNaN(e) ? ba : function (t) {
      ba(t), t[1] = function _offsetPoints(t, e) {
        ...
        for (r = "reverse" === e ? (n = i - 1, -2) : (n = (2 * (parseInt(e, 10) || 0) + 1 + 100 * i) % i, 2), a = 0; a < i; a += 2) {
          h += o[n - 1] + "," + o[n] + " ", n = (n + r) % i;
        }
  ...
  function ea(t, e) {
    for (var r, n, a, o, i, h, s, l, g, c, p, u, f = t.length, d = .2 * (e || 1); -1 < --f;) {
      for (p = (n = t[f]).isSmooth = n.isSmooth || [0, 0, 0, 0], u = n.smoothData = n.smoothData || [0, 0, 0, 0], p.length = 4, l = n.length - 2, s = 6; s < l; s += 6) {
        a = n[s] - n[s - 2], o = n[s + 1] - n[s - 1], i = n[s + 2] - n[s], h = n[s + 3] - n[s + 1], g = w(o, a), c = w(h, i), (r = Math.abs(g - c) < d) && (u[s - 2] = g, u[s + 2] = c, u[s - 1] = _(a * a + o * o), u[s + 3] = _(i * i + h * h)), p.push(r, r, 0, 0, r, r);
      }
  ...
  var r,
    ...
    init: function init(t, e, r, n, a) {
      ...
      if (z(e) && (e = e.call(r, n, t, a)), "string" == typeof e || e.getBBox || e[0]) e = {
        shape: e
      };else if ("object" == (0, _typeof2["default"])(e)) {
        for (i in o = {}, e) {
      ...
      if (g = e.shapeIndex || 0 === e.shapeIndex ? e.shapeIndex : "auto", c = e.map || K.defaultMap, this._prop = e.prop, this._render = e.render || K.defaultRender, this._apply = "updateTarget" in e ? e.updateTarget : K.defaultUpdateTarget, this._rnd = Math.pow(10, isNaN(e.precision) ? 2 : +e.precision), this._tween = r, s) {
        if (this._target = t, w = "object" == (0, _typeof2["default"])(e.precompile), f = this._prop ? t[this._prop] : t.getAttribute(i), this._prop || t.getAttributeNS(null, "data-original") || t.setAttributeNS(null, "data-original", f), "d" === i || this._prop) {
          ...
          for ("log" !== e.precompile && !0 !== e.precompile || M('precompile:["' + rawPathToString(f) + '","' + rawPathToString(d) + '"]'), (S = "linear" !== (e.type || K.defaultType)) && (f = ea(f, e.smoothTolerance), d = ea(d, e.smoothTolerance), f.size || Q(f), d.size || Q(d), b = fa(j[0]), this._origin = f.origin = {
            ...
            for (m = f[P], y = d[P], p = m.isSmooth || [], u = y.isSmooth || [], v = m.length, _ = F = 0; _ < v; _ += 2) {
              y[_] === m[_] && y[_ + 1] === m[_ + 1] || (S ? p[_] && u[_] ? (x = m.smoothData, T = y.smoothData, N = _ + (_ === v - 4 ? 7 - v : 5), this._controlPT = {
    ...
    render: function render(t, e) {
      for (var r, n, a, o, i, h, s, l, g, c, p, u, f = e._rawPath, d = e._controlPT, _ = e._anchorPT, P = e._rnd, v = e._target, m = e._pt; m;) {
        m.r(t, m.d), m = m._next;
      }
      ...
      if (1 === t && e._apply) for (m = e._pt; m;) {
        ...
        for (; _;) {
          i = _.sa + t * _.ca, o = _.sl + t * _.cl, _.t[_.i] = e._origin.x + j(i) * o, _.t[_.i + 1] = e._origin.y + L(i) * o, _ = _._next;
        }

        for (n = t < .5 ? 2 * t * t : (4 - 2 * t) * t - 1; d;) {
          u = (h = d.i) + (h === (a = f[d.j]).length - 4 ? 7 - a.length : 5), i = w(a[u] - a[h + 1], a[u - 1] - a[h]), c = L(i), p = j(i), l = a[h + 2], g = a[h + 3], o = d.l1s + n * d.l1c, a[h] = l - p * o, a[h + 1] = g - c * o, o = d.l2s + n * d.l2c, a[u - 1] = l + p * o, a[u] = g + c * o, d = d._next;
        }

        if (v._gsRawPath = f, e._apply) {
          for (r = "", s = 0; s < f.length; s++) {
            for (o = (a = f[s]).length, r += "M" + (a[0] * P | 0) / P + " " + (a[1] * P | 0) / P + " C", h = 2; h < o; h++) {
              r += (a[h] * P | 0) / P + " ";
            }
          }
