...
!function (t, e) {
  ...
  function sliceRawPath(t, e, n) {
    ...
    if (p || a) {
      if (x(c, w, M, d.t) && (i = 1, w++, T ? R ? m.t /= d.t : (m.t = (m.t - d.t) / (1 - d.t), P++, b = 0) : w <= P + 1 && !R && (P++, L && (b -= M))), m.t ? x(c, P, b, m.t) && (R && i && w++, r && P++) : (P--, r && w--), h = [], f = 1 + (u = c.length) * a, g = w, r) for (f += (u - (P = (P || u) - 1) + w) % u, l = 0; l < f; l++) {
        A(h, c[g]), g = (g || u) - 1;
      } else for (f += (u - w + P) % u, l = 0; l < f; l++) {
        A(h, c[g++ % u]);
      }
      c = h;
    } else if (s = 1 === m.t ? 6 : subdivideSegment(v, b, m.t), e !== n) for (i = subdivideSegment(y, M, T ? d.t / m.t : d.t), L && (s += i), v.splice(b + s + 2), (i || M) && y.splice(0, M + i), l = c.length; l--;) {
  ...
  function measureSegment(t, e, n) {
    ...
    for (R.length = S.length = 0, a = e + 2; a < b; a += 6) {
      if (o = t[a + 4] - M, i = t[a + 2] - M, s = t[a] - M, u = t[a + 5] - L, f = t[a + 3] - L, g = t[a + 1] - L, l = h = c = p = 0, Q(o) < 1e-5 && Q(u) < 1e-5 && Q(s) + Q(g) < 1e-5) 8 < t.length && (t.splice(a, 6), a -= 6, b -= 6);else for (r = 1; r <= P; r++) {
  ...
  function arcToSegment(t, e, n, r, a, o, i, s, l) {
    if (t !== s || e !== l) {
      ...
      for (G = 0; G < D; G++) {
        m = H(a = I + G * W), v = F(a), _ = H(a += W), C = F(a), z.push(m - Y * v, v + Y * m, _ + Y * C, C - Y * _, _, C);
      }
  ...
  function stringToRawPath(t) {
    ...
    for (e = 0; e < P; e++) {
      if (c = o, isNaN(m[e]) ? i = (o = m[e].toUpperCase()) !== m[e] : e--, r = +m[e + 1], a = +m[e + 2], i && (r += x, a += y), e || (l = r, h = a), "M" === o) s && (s.length < 8 ? --v.length : w += s.length), x = l = r, y = h = a, s = [r, a], v.push(s), e += 2, o = "L";else if ("C" === o) i || (x = y = 0), (s = s || [0, 0]).push(r, a, x + 1 * m[e + 3], y + 1 * m[e + 4], x += 1 * m[e + 5], y += 1 * m[e + 6]), e += 6;else if ("S" === o) u = x, f = y, "C" !== c && "S" !== c || (u += x - s[s.length - 4], f += y - s[s.length - 3]), i || (x = y = 0), s.push(u, f, r, a, x += 1 * m[e + 3], y += 1 * m[e + 4]), e += 4;else if ("Q" === o) u = x + 2 / 3 * (r - x), f = y + 2 / 3 * (a - y), i || (x = y = 0), x += 1 * m[e + 3], y += 1 * m[e + 4], s.push(u, f, x + 2 / 3 * (r - x), y + 2 / 3 * (a - y), x, y), e += 4;else if ("T" === o) u = x - s[s.length - 4], f = y - s[s.length - 3], s.push(x + u, y + f, r + 2 / 3 * (x + 1.5 * u - r), a + 2 / 3 * (y + 1.5 * f - a), x = r, y = a), e += 2;else if ("H" === o) rf(x, y, x = r, y), e += 1;else if ("V" === o) rf(x, y, x, y = r + (i ? y - x : 0)), e += 1;else if ("L" === o || "Z" === o) "Z" === o && (r = l, a = h, s.closed = !0), ("L" === o || .5 < Q(x - r) || .5 < Q(y - a)) && (rf(x, y, r, a), "L" === o && (e += 2)), x = r, y = a;else if ("A" === o) {
        if (p = m[e + 4], d = m[e + 5], u = m[e + 6], f = m[e + 7], n = 7, 1 < p.length && (p.length < 3 ? (f = u, u = d, n--) : (f = d, u = p.substr(2), n -= 2), d = p.charAt(1), p = p.charAt(0)), g = arcToSegment(x, y, +m[e + 1], +m[e + 2], +m[e + 3], +p, +d, (i ? x : 0) + 1 * u, (i ? y : 0) + 1 * f), e += n, g) for (n = 0; n < g.length; n++) {
          s.push(g[n]);
        }
  ...
  function pointsToSegment(t, e, n) {
    ...
    for (isNaN(n) && (n = Math.PI / 10), T && (t.push(P, w), P = x, w = y, x = t[v - 2], y = t[v - 1], t.unshift(x, y), v += 4), e = e || 0 === e ? +e : 1, s = 2; s < v; s += 2) {
      r = x, a = y, x = P, y = w, p = (l = M) * l + (u = L) * u, d = (M = (P = +t[s + 2]) - x) * M + (L = (w = +t[s + 3]) - y) * L, m = (h = P - r) * h + (f = w - a) * f, c = (o = Math.acos((p + d - m) / $(4 * p * d))) / Math.PI * e, g = $(p) * c, c *= $(d), x === r && y === a || (n < o ? (i = S(f, h), b.push(C(x - H(i) * g), C(y - F(i) * g), C(x), C(y), C(x + H(i) * c), C(y + F(i) * c))) : (i = S(u, l), b.push(C(x - H(i) * g), C(y - F(i) * g)), i = S(L, M), b.push(C(x), C(y), C(x + H(i) * c), C(y + F(i) * c))));
    }
  ...
  function Y(t, e) {
    var n,
        ...
        h = s ? T : G;
    if (t === c) return t;
    if (h.length || h.push(W(t, 1), W(t, 2), W(t, 3)), n = s ? f : u, s) a = l ? {
      x: 0,
      y: 0
      ...
      if (o = i = 0, P) for (r = t.offsetParent, a = t; (a = a && a.parentNode) && a !== r && a.parentNode;) {
        4 < (c.getComputedStyle(a)[w] + "").length && (o = a.offsetLeft, i = a.offsetTop, a = 0);
      }
  ...
  function getGlobalMatrix(t, e, n) {
    ...
    var r = function _forceNonZeroScale(t) {
      for (var e, n; t && t !== v;) {
        (n = t._gsap) && !n.scaleX && !n.scaleY && n.renderTransform && (n.scaleX = n.scaleY = 1e-4, n.renderTransform(1, n), e ? e.push(n) : e = [n]), t = t.parentNode;
      }
    ...
    if (h.removeChild(o), r) for (i = r.length; i--;) {
  ...
  function ka(t, e, n, r, a, o, i) {
    return e = "cubic" === i.type ? [e] : (e.unshift(ia(n, r, i.unitX), a ? ia(n, a, i.unitY) : 0), i.relative && ja(e), [(a ? pointsToSegment : flatPointsToSegment)(e, i.curviness)]), e = o(tt(e, n, i)), et(t, n, r, e, "x", i.unitX), a && et(t, n, a, e, "y", i.unitY), cacheRawPathMeasurements(e, i.resolution || (0 === i.curviness ? 20 : 12));
  }
  ...
  var z,
    ...
    }) : u = [ia(e, "xPercent") / -100, ia(e, "yPercent") / -100], o = (a = oa(e, r, u, "auto")).apply({
      x: f,
      y: g
    ...
    init: function init(t, e) {
      ...
      "object" == (0, _typeof2["default"])(e) && !e.style && e.path || (e = {
        path: e
      });
      ...
      if (this.rawPaths = i, this.target = t, (this.rotate = h || 0 === h) && (this.rOffset = parseFloat(h) || 0, this.radians = !!e.useRadians, this.rProp = e.rotation || "rotation", this.rSet = t._gsap.set(t, this.rProp, this), this.ru = k(t._gsap.get(t, this.rProp)) || 0), !Array.isArray(s) || "closed" in s || "number" == typeof l) cacheRawPathMeasurements(n = u(tt(getRawPath(e.path), t, e)), e.resolution), i.push(n), et(this, t, e.x || "x", n, "x", e.unitX || "px"), et(this, t, e.y || "y", n, "y", e.unitY || "px");else {
        ...
        for (r in a && o ? i.push(ka(this, ha(ha([], s, a, 0), s, o, 1), t, e.x || a, e.y || o, u, e)) : a = o = 0, l) {
  ...
  }() || z.registerPlugin(a), t.MotionPathPlugin = a, t["default"] = a;
