...
var subtitle_writer = document.querySelector('#subtitle_writer');
new Typed(subtitle_writer, {
  blink: true,
  printErrors: false,
  blinkClasses: ["blinker"],
  blinkSpeed: 600
}).type("Développeur").type(" Front End", {
  color: "#3f51b5"
}).pause(2000)["delete"](8).pause(1000).type("Back End", {
  color: "#ff9800"
}).pause(2000)["delete"](7).pause(1000).type("FullStack", {
  fontWeight: "bold",
  color: "#f44336"
}).run();
/*============================
...
var sun_svg = document.querySelector("#sun-svg");
var sun_svg__death = document.querySelector("#sun-svg--death");
var sun_svg__outline = document.querySelector("#sun--outline");
var sun_svg__ellipse = document.querySelector("#sun--ellipse");
var sun_svg__pathinside = document.querySelector("#sun--path--inside");
var anim_steps = 0;
var sunToggle = true;
...
sun_svg.addEventListener("click", function (e) {
  ...
  if (anim_steps === 0) {
    ...
    setTimeout(function () {
      ...
      var wrapper = sun_svg.parentNode;
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          var planets = document.querySelectorAll(".menu_planet");
          var dText = document.querySelector("#disappearingText");
          increaseSpeed(false);
          var i = 0;
